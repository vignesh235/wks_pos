  ...
  clear_all_amounts() {
    ...
    validate_due_date() {
     ...
     const textThree = item.address_line2
        ...
        const textFive = item.phone1 ? item.phone1.toLowerCase() : '';
        const textSix = item.phone2 ? item.phone2.toLowerCase() : '';
        const textSeven = item.phone3 ? item.phone3.toLowerCase() : '';
        const textEigth = item.primary_address ? item.primary_address.toLowerCase() : '';
        ...
        return (
          ...
          textEigth.indexOf(searchText) > -1
        );
      },
      new_address() {
