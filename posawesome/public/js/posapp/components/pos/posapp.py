...
def get_items(pos_profile, price_list=None):
    ...
    for i in range(len(items_data)):
        if(items_data[i].item_code in items):
            # frappe.errprint(get_stock_availability(items_data[i].item_code,item_warehouse[items_data[i].item_code]))
            # frappe.errprint("PPP")
    ...
    if items_data:
        ...
        for item in items_data:
            ...
            if pos_profile.get("posa_display_items_in_stock"):
                ...
                frappe.errprint(item_stock_qty)
                frappe.errprint('LLL')
...
def customer_bls_details(cus):
    cus=frappe.get_all("Customer",filters={'customer_name':cus},fields=['state','city','pin_code_','pan','gstin','customer_type'])  
    return cus 
...
def set_customer_info(fieldname, customer, value=""):
    ...
    'customer_group':'Customer','city':'Address','pin_code_':'Customer','customer_type':'Customer','gstin':'Customer','pan':'Customer','state':'Customer'}
